...
// #region FontAwesome5
export type FonAwesome5NameType =
    | '500px'
    | 'accessible-icon'
    | 'accusoft'
...
// #region MaterialCommunityIcons
export type MaterialCommuityIconsNameType =
    | 'ab-testing'
    | 'abacus'
    | 'abjad-arabic'
    | 'abjad-hebrew'
...
// #region SimpleLineIcons
export type SimpleLineIconsNameType =
    | 'user'
    | 'people'
    | 'user-female'
    | 'user-follow'
